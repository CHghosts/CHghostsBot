module.exports = {
    name: "setdepart",
    model: "!setdepart",
    description: "Cette commande permet de designer le channel ou cette commande et tapper comme channel de départ du serveur",
    ...
    execute(bot, msg, args) {
        ...
        fs.readFile(`./paramServer/${idGuild}.json`, 'utf8', function(error, data){
            if (!error) {
                ...
                parramServer.channelDepartId = msg.channel.id;
                ...
                fs.writeFile(`./paramServer/${idGuild}.json`, resultModif, (err) => {
                    ...
                    msg.channel.send(`Le channel <#${msg.channel.id}> vien d'etre defini comme channel de départ`);
                });
            }else {
